...
class Stars extends React.Component
{
  constructor(props){
    super(props);
    this.state = {bookname:this.props.bookname, stars:0, 
...
fifth:"https://s.gr-assets.com/images/layout/gr_red_star_inactive.png"}
  ...
  sendToDB()
  {
    // const uname = this.props.name
    const stars = String(this.state.stars)
    console.log(uname)
    const senddata = {uname,stars}
    console.log(senddata)
    // CHANGE QWERTY HERE
    axios.post("http://localhost:9002/home/qwerty", senddata)
        .then(res => {
